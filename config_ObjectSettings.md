...
| `addHealthToToolAfterUse` | `array[number]` | Изменение прочности инструмента fact, если 0 то min, max. Может быть только положительным| `[0.0, 0.0, 0.0]` |
| `addQuantityToToolAfterUse` | `array[number]` | Изменение количества инструмента fact, если 0 то min, max Может быть положительным и отрицательным| `[0.0, 0.0, 0.0]` |
| **Настройка мини игр** |
...
| `lp_RotationSpeed` | `float` | Скорость вращения индикатора | 180 градусов в сек|
